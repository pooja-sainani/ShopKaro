...
import cfh.com.shopkaro.dummy.DummyContent.DummyItem;
...
public class MyproductRecyclerViewAdapter extends RecyclerView.Adapter<MyproductRecyclerViewAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        //holder.mContentView.setText(mValues.get(position).cost);
        holder.mProductDescription.setText(mValues.get(position).content);
