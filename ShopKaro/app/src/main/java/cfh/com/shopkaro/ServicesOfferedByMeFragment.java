...
public class ServicesOfferedByMeFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Log.e("Fragment", "ONCREATE Services OfferedBy me");
    }
    ...
    private class GetServicesOfferedByMeTask extends AsyncTask<String, Integer, String> {
        @Override
        ...
        protected String doInBackground(String... params) {
            ...
            HttpGet httpGet = new HttpGet("http://shopkaroapi.azurewebsites.net/api/Services/GetAllServicesOfferedByMe/"+ userid);
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                for(int i=0;i<json.length();i++){
                    ...
                    Service item= new Service(jobj.getString("NAME"), jobj.getDouble("AVGRATING"), jobj.getInt("NUMBEROFUSERS"));
                    services.add(item);
                }
                recyclerView.setAdapter(new ServicessOfferedByMeRecyclerViewAdapter(services));
